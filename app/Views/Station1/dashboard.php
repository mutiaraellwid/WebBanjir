                    ...
                    <div class="card card-danger">
                        ...
                        <div class="body-card">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-6">
                                    <div class="card-body">
                                        <h5 style="text-align: center; margin-top: 15px; margin-bottom: 15px; font-size:36px;
                                            " class="animated infinite flash">
                                            OH NO..
                                        </h5>
                                        <br>
                                        <p
                                            style="border: solid 3px rgb(209, 17, 17); background: rgb(209, 17, 17); margin-bottom: 15px; text-align: center; color: white; font-size: 36px">
                                            Waspada!
                                        </p>
                                        <br>
                                        <p style="text-align: justify;"> saat ini ketinggian air sudah mencapai level
                                            waspada, diharapkan
                                            tetap
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-6">
                                    <div class="card-body">
                                        ...
                                        <br>
                                        <p
                                            style="border: solid 3px rgb(227, 230, 54); background: rgb(227, 230, 54); margin: 0; text-align: center; color: black; font-size: 36px">
                                            Siaga!
                                        </p><br>
                                        <p style="text-align: justify"> saat ini ketinggian air sudah mencapai level siaga, diharapkan tetap
                                            hati-hati dan terus mengecek kondisi air sungai secara berkala sampai status
                                            aman.
                                        </p>
                                    </div>
                    ...
                    <div class="card card-success">
                        ...
                        <div class="body-card">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-6">
                                    <div class="card-body">
                                        <h6 style="text-align: center; margin-top: 15px; margin-bottom: 15px; font-size:36px;
                                            " class="animated infinite pulse">
                                            DON'T WORRY..
                                        </h6>
                                        <br>
                                        <p
                                            style="border: solid 3px rgb(27, 128, 1); background: rgb(27, 128, 1); margin: 0; text-align: center; color: white; font-size: 36px">
                                            Aman!
                                        </p>
                                        <br>
